...
* [Web Sockets Streams](#web-socket-streams)
    ...
    * [TransferStream](#transfer-stream)
    * [TradesStream](#trades-stream)
    * [DiffDepthStream](#diff-depth-stream)
    * [BookDepthStream](#book-depth-stream)
    * [CandlestickStream](#candlestick-stream)
    * [TickerStream](#ticket-stream)
    * [AllSymbolsTickerStream](#all-symbols-ticker-stream)
